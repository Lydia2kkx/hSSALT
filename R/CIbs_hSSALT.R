...
CIbs_hSSALT <-function(data, n, censoring, tau , r, monitoring, delta, alpha, B, theta1, theta_21,
  ...
  if (monitoring=="Interval"){
    ...
    bootstrap_distri <- bootstrap_continuous(data, n, censoring, tau , r, B,
  ...
  return(list(CI_theta1 = quantile(bootstrap_distri$theta1, c(alpha/2, 1-alpha/2)),
