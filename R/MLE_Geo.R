MLE_Geo<- function( data , n , tau , delta, theta21 , theta22 , p, maxit, tol, language, parallel, ncores ){
  ...
  if(language == "CPP") {
    ...
    if (dim(parameter_starts)[1]==1){
      ...
      EM_mle$ind <-NULL
      return(c(mle1=mle1, n1=n1, mle2=as.list(EM_mle), n2=n2, censored_rate=1-(n1+n2)/n ))
    }else{
      ...
      return(list(mle1=mle1, n1=n1, mle2=mle_em, n2=n2, censored_rate=1-(n1+n2)/n, estimates=Estimate_df))
    }
